                      ...
                      {solutionLinks.map((item) => {
                        ...
                        return (
                          <Link
                            key={item.href}
                            href={item.href}
                            className="flex items-center gap-3 p-2 rounded-lg hover:bg-white/5 transition-all duration-200 group/item"
                          >
                            <div
                            ...
                            <div className="flex flex-col gap-0.5">
                              <span className="text-sm font-semibold text-white group-hover/item:text-white transition-colors">
                                {item.name}
                              </span>
                              <span className="text-xs text-gray-400">
                                {item.description}
                  ...
                  {solutionLinks.map((item) => {
                    ...
                    return (
                      <Link
                        ...
                        href={item.href}
                        onClick={() => setMobileMenuOpen(false)}
                        className="flex items-center gap-2 text-sm text-gray-400 hover:text-white py-1.5 transition-colors block"
                      >
